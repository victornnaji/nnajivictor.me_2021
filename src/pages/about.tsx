...
const About: React.FC<PageProps> = ({location}) => {
  ...
  return (
    <>
      <Seo url={get_url("about")} title="About Nnaji Victor" />
        ...
        <StyledAboutPage>
          <div className="about__hero">
            ...
            <div className="about__hero--column">
              ...
              <p className="text-paragraph">
                ...
                technologies. I love to create intrinsic user interface and
                useful interaction, developing rich web experiences & web
                applications.
              </p>
              <p className="text-paragraph">
                I have spent the last 3 years working along senior and
                experienced developers who have raised my standards for what is
                expected to take up any project and create excellent products
                and not just that, but one written in maintainable and easy to
                read codes.
              </p>
          ...
          <div className="about__other-section">
            ...
            <div className="other-activities">
              ...
              <div className="content">
                ...When i'm not coding, I love to play{" "}
                <span className="activity">Fifa</span>, I'm pretty very good at
                it. I also enjoy watching superhero movies espacially one from
                the &nbsp; <span className="activity">MCU</span>. I like
                checking out random things on{" "}
                <span className="activity">YouTube</span>. The most important of
                them all being <span className="activity">Music</span> - I
